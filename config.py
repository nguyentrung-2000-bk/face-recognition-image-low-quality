...
def get_args():
    ...
    parent_parser.add_argument('--train_data_path', type=str, default='AFD_Images_blur')
    ...
    parent_parser.add_argument('--epochs', default=200, type=int, metavar='N', help='number of total epochs to run')
    ...
    parent_parser.add_argument('--lr',help='learning rate',default=1e-2, type=float)
    ...
    parent_parser.add_argument('--resume_from_checkpoint', type=str, default='/data/trungnv/AdaFace/experiments/default_07-14_1/ir18_casia.ckpt')
    parent_parser.add_argument('--start_from_model_statedict', type=str, default='../Face_Recognition/pretrained/adaface_ir18_casia.ckpt')
